...
x0 = [0.25;0.75;0.25];   tinic = 0;  tfin = 10;  N = 400;
...
x0 = [0;5;75];   tinic = 0;  tfin = 10;  N = 400;
sigma = 10; ro = 10; b = 8/3;
par = [sigma,ro,b];
%}
%DUFFING
%{ 
fun = @funcpendulolin;  jac = @jacfunpendulolin;
x0 = [theta0;w0];   tinic = 0;  tfin = 10;  N = 400;
a = 0;
par = [a];
%}
%COMPETICION
...
x0 = [30;50];   tinic = 0;  tfin = 100;  N = 4000;
a = 3; b = 0.2; c = 0.6; d = 5;
par = [a,b,c,d];
%}
%PENDULO LINEAL
...
x0 = [-pi;1e-6];   tinic = 0;	tfin = 18;	N = 1000;
M = 0; l = 1; g = 9.8; beta = 0; 
par = [M,l,g,beta];
%}
%RIGIDA
...
x0 = 0;	tinic = 0;	tfin = pi/2;    N = 4000;
%}
%VANDERPOL
%{
fun = @funcvanderpol;   jac = @jacfuncvanderpol;
x0 = [2;8]; tinic = 0;  tfin = 100;  N = 4000;
a = 30; b = 1;
par = [a,b];
%}
%CORAZON
...
x0 = [0;2]; tinic = 0;  tfin = 2*pi; N = 1000;
%}