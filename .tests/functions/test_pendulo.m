classdef test_pendulo < unittestfunction
    properties (Constant)
        function_name = 'funcpendulo';
    end
    methods
        function obj = test_pendulo(u,b)
